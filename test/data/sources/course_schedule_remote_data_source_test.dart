...
void main() {
  ...
  group('CourseScheduleRemoteDataSource', () {
    group('getCourseScheduleEvents', () {
      test(
        'returns list of CourseScheduleEventModel on successful response',
        () async {
          // GIVEN
          final eventsJson = [
            givenCourseScheduleEventJson(id: 1, title: 'Intro to CS - Lecture'),
            givenCourseScheduleEventJson(id: 2, title: 'Calculus - Lecture'),
          ];
          when(
            () => mockDio.get(
              any(),
          ...
          // WHEN
          final result = await dataSource.getCourseScheduleEvents(
          ...
          expect(result[0].title, equals('Intro to CS - Lecture'));
          expect(result[1].title, equals('Calculus - Lecture'));
        },
      );
      ...
      test('throws ServerException on invalid response format', () async {
        ...
        // WHEN/THEN
        expect(
          () => dataSource.getCourseScheduleEvents(
            from: DateTime(2025, 8, 1),
            to: DateTime(2025, 12, 31),
          ),

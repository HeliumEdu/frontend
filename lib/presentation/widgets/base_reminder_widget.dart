...
abstract class BaseReminderWidget extends StatelessWidget {
  ...
  BaseReminderWidgetContent buildContent();
...
abstract class BaseReminderWidgetContent extends StatefulWidget {
  final int entityId;
  final bool isEdit;
  final UserSettingsModel? userSettings;

  const BaseReminderWidgetContent({
    super.key,
    required this.entityId,
    required this.isEdit,
    this.userSettings,
...
abstract class BaseReminderWidgetState<T extends BaseReminderWidgetContent>
    extends State<T> {
  // State

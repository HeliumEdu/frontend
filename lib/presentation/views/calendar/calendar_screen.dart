...
import 'package:heliumapp/presentation/bloc/event/event_event.dart';
import 'package:heliumapp/presentation/bloc/event/event_state.dart';
...
import 'package:heliumapp/presentation/bloc/homework/homework_bloc.dart';
import 'package:heliumapp/presentation/bloc/homework/homework_event.dart';
import 'package:heliumapp/presentation/bloc/homework/homework_state.dart';
...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  Color _externalCalendarColor(int calendarId) {
    for (final calendar in _externalCalendars) {
      if (calendar.id == calendarId) {
        return hexToColor(calendar.color);
      }
    }
    return blackColor;
  }
  ...
  List<Color> _getColorDotsForDate(
    ...
    if (showEvents && _hasEventsOnDate(date, events)) {
      dots.add(hexToColor(_userSettings.eventsColor));
    }
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  color: hexToColor(_userSettings.eventsColor),
        ...
        child: Scaffold(
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                Navigator.pushNamed(context, AppRoutes.calendarAddAssignmentScreen);
              },
  ...
  Widget _buildEventCard(BuildContext context, EventResponseModel event) {
    Color eventColor = hexToColor(_userSettings.eventsColor);
    String timeDisplay = '';
    try {
      if (event.allDay) {
        timeDisplay = 'All day';

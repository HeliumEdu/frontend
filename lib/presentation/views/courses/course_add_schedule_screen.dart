...
class CourseAddScheduleScreen extends StatefulWidget {
  ...
  @override
  State<CourseAddScheduleScreen> createState() =>
      _CourseAddScheduleScreenState();
}

class _CourseAddScheduleScreenState extends State<CourseAddScheduleScreen> {
        ...
        listener: (context, state) {
          ...
          if (state is CourseDetailLoading) {
            ...
            Navigator.pushReplacementNamed(
              context,
              AppRoutes.courseAddCategoryScreen,
              arguments: {
                'courseId': widget.courseId,

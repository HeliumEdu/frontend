...
class CourseAddCategoryScreen extends StatefulWidget {
  final int courseId;
  final int courseGroupId;
  final bool isEdit;

  const CourseAddCategoryScreen({
    super.key,
  ...
  @override
  State<CourseAddCategoryScreen> createState() =>
      _CourseAddCategoryScreenState();
}

class _CourseAddCategoryScreenState
    extends State<CourseAddCategoryScreen> {

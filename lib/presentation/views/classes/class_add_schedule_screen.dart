...
class ClassAddScheduleScreen extends StatefulWidget {
  final int courseId;
  final int courseGroupId;
  final bool isEdit;

  const ClassAddScheduleScreen({
    super.key,
  ...
  @override
  State<ClassAddScheduleScreen> createState() =>
      _ClassAddScheduleScreenState();
}

class _ClassAddScheduleScreenState extends State<ClassAddScheduleScreen> {
        ...
        listener: (context, state) {
          ...
          if (state is CourseDetailLoading) {
            ...
            Navigator.pushReplacementNamed(
              context,
              AppRoutes.classesAddCategoryScreen,
              arguments: {
                'courseId': widget.courseId,

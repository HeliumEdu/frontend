...
class ClassAddCategoryScreen extends StatefulWidget {
  final int courseId;
  final int courseGroupId;
  final bool isEdit;

  const ClassAddCategoryScreen({
    super.key,
  ...
  @override
  State<ClassAddCategoryScreen> createState() =>
      _ClassAddCategoryScreenState();
}

class _ClassAddCategoryScreenState
    extends State<ClassAddCategoryScreen> {
  ...
  void _showCategoryDialog({CategoryModel? existingCategory}) {
    ...
    if (isEdit) {
      ...
      selectedColor = hexToColor(existingCategory.color);
    } else {
                      ...
                      child: EasyStepper(
                        ...
                        onStepReached: (index) {
                          ...
                          if (index == 1) {
                            Navigator.pushReplacementNamed(
                              context,
                              AppRoutes.classesAddScheduleScreen,
                              arguments: {
                                'courseId': widget.courseId,
                                'courseGroupId': widget.courseGroupId,
                                'isEdit': true,

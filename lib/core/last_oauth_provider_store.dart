...
/// `accountName` (iOS), `sharedPreferencesName` (Android) and `publicKey`
/// (web) give it its own storage namespace so `PrefService().clear()` (every
/// Helium logout) can't wipe it - the highlight matters most right after
/// logging out.

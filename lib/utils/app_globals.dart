...
class CalendarConstants {
  ...
  static final List<DropDownItem<String>> dayNamesItems = _listToDropDownItems(
    dayNames,
  );
...
class ReminderConstants {
  ...
  static final List<DropDownItem<String>> offsetTypeItems =
...
class ResourceConstants {
  ...
  static final List<DropDownItem<String>> statusItems = _listToDropDownItems(
    status,
  );
  ...
  static final List<DropDownItem<String>> conditionItems = _listToDropDownItems(
    condition,
  );
}

...
function Helium() {
    ...
    this.COLOR_PICKER_DEFAULTS = {
        ...
        cancelText: "Cancel",
        palette: [
            ["#5E0C23", "#901336", "#B91846",
             "#E21D55", "#E74674", "#EC6F92"],
            ["#3C1B0C", "#622C13", "#7B3718",
             "#AF4F23", "#D5602A", "#DC7D50"],
            ["#372810", "#5A411B", "#7E5A26",
             "#A17430", "#C48D3B", "#CFA25E"],
            ["#024B35", "#037251", "#049F71",
             "#05CC90", "#06F9B0", "#33FABE"],
            ["#0D0E38", "#16175F", "#1F2184",
             "#282AA9", "#3033CF", "#5658D7"],
            ["#3C1534", "#571E4C", "#792A69",
             "#9B3687", "#BD42A4", "#C964B5"],
            ["#553555", "#643F64", "#815181",
             "#9D629D", "#AE7EAE", "#C09BC0"]
        ],
    }
